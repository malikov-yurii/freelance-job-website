...
public class ProjectTestData {
    public static final Project PROJECT_1_ADULT_SHOP = new Project(1, "Online shop of adult toys", ProjectStatus.LOOKING_FOR_FREELANCER,
            ...
            new HashSet<>(Arrays.asList(HTML, CSS, JAVASCRIPT)), Collections.emptyList());
    public static final Project PROJECT_2_NEW_GOOGLE = new Project(2, "New search system", ProjectStatus.LOOKING_FOR_FREELANCER,
            "I have idea. You should hack Google or Yandex. And to user its source code for our new search system. We will spit benefits 50/50", new BigDecimal(3000).setScale(2), CLIENT_2_ROZA, null, Collections.emptyList(),
            new HashSet<>(Collections.singletonList(JAVA)), new ArrayList<>(Arrays.asList(PROJECT2_YURII_COMMENT_1, PROJECT2_ROZA_COMMENT_2)));
    public static final Project PROJECT_3_SHOPPING_CARD = new Project(3, "Shopping card", ProjectStatus.IN_PROGRESS,
            "Add shopping card to my online shop", new BigDecimal(50).setScale(2), CLIENT_3_ISAAK, FREELANCER_2_DENIS, Collections.emptyList(),
            new HashSet<>(Arrays.asList(HTML, CSS)), Collections.emptyList());
    public static final Project PROJECT_4_FILTER = new Project(4, "Filter for products", ProjectStatus.IN_PROGRESS,
            ...
            new HashSet<>(Collections.singletonList(JAVA)), Collections.emptyList());
    public static final Project PROJECT_5_CRM = new Project(5, "CRM", ProjectStatus.FINISHED,
            ...
            new HashSet<>(Arrays.asList(HTML, CSS, JAVASCRIPT, JAVA, SQL, HIBERNATE, SPRING, MAVEN)), Collections.emptyList());
    public static final Project PROJECT_6_VISIT_CARD = new Project(6, "Visit card website", ProjectStatus.LOOKING_FOR_FREELANCER,
            ...
            new HashSet<>(Arrays.asList(HTML, CSS)), new ArrayList<>(Arrays.asList(PROJECT6_YURII_COMMENT_3, PROJECT6_DENIS_COMMENT_4)));
